...
export function About() {
  return (
    <section id="about" className=" flex items-center px-6 md:px-12 lg:px-20 py-20">
      <div className="max-w-4xl">
        <h2 className="text-sm text-muted-foreground mb-8 uppercase tracking-wider">About</h2>
